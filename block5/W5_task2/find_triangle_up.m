...
function [ bbox_out,mask_out ] = find_triangle_up( BW,tol,tol_rot,windowCandidates,plot_flag)
if nargin<5
    plot_flag = true;
end
if nargin<3
...
for  ww = 1: length( windowCandidates)
    ...
    %P-3
    %===
    I = find(all_points3.p1(:,2)==min(all_points3.p1(:,2)));
    p1 = all_points3.p1(I(1),:);
    all_points3.p1 = p1;%[all_points3.p1;p1];
    I = find(all_points3.p2(:,2)==max(all_points3.p2(:,2)));
