function positive_bounding_boxes = remove_duplicates(positive_bounding_boxes, positive_bounding_boxes_coordinates,score)
...
[selectedBbox,selectedScore] = selectStrongestBbox(positive_bounding_boxes_coordinates,score);
for ii=1:(length(positive_bounding_boxes)-1)
    ...
    if plot_flag
     ...
     area = rectint(positive_bounding_boxes_coordinates{ii},positive_bounding_boxes_coordinates{ii+1})
